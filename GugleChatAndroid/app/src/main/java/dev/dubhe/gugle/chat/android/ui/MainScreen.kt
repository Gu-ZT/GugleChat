...
@Composable
fun MainScreen(viewModel: ChatViewModel, onLogout: () -> Unit, onRequestAudioPermission: (Channel) -> Boolean = { true }) {
    ...
    if (inVoiceCall) {
        ...
        ChannelListScreen(
            ...
            { ch -> if (onRequestAudioPermission(ch)) viewModel.startVoiceCall(ch) },
